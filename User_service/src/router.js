...
const {createuser,userlogin} = require('../src/controller/user_controller');
const { setTokenCookie, verifyTokenFromCookie, clearTokenCookie } = require('../src/middleware/cookieAuth');
const { createPartner, partnerLogin, getPartnerPhoneCompany } = require('../src/controller/partner_controller');
